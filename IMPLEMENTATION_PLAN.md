...
- 2026-09-22: Public README media continuation is partially complete: extracted and verified the real 1024×1024 app icon and added it to the README header. The user chose to supply the screenshots, so no screenshot was captured or fabricated; resume with `clock-window.png`, `countdown.png` and `settings.png` under `docs/assets/readme/` when provided.
